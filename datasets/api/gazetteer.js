...
function lpHTML(property,item=feature) {
	...
	case 'links':
		...
		item.links.forEach(function(link){
			aggregator.push('<p class="link"><a title="'+link.type+' '+link.identifier+' (opens in new window)" href="'+link.identifier+'">'+(link.hasOwnProperty('label')?truncate(link.label):link.identifier)+'</a></p>');
		});
